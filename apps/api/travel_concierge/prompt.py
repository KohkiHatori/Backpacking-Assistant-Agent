...
- If the user asks about finding flight deals, making seat selection, or lodging, OR wants to create a trip blueprint/plan, transfer to the agent `planning_agent`
...
Trip phases:
ONLY if the user is NOT asking to plan/create a new trip, and we have a non-empty itinerary, follow the following logic to deteermine a Trip phase:
...
IMPORTANT: If the user wants to "Plan", "Create", or "Generate" a trip/blueprint, ALWAYS choose `planning_agent`, ignoring the dates above.
"""
